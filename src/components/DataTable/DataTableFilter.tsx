...
import { DataTableFilterComponent, DataTableInstance } from './DataTable';

const StringFilterInput: DataTableFilterComponent<string> = ({
    value,
    onChange,
}) => (
    <TextInput
...
const NumberRangeFilter: DataTableFilterComponent<
...
const defaultFilters: Record<string, DataTableFilterComponent> = {
...
export const DataTableFilter = ({ column }: { column: Column<any> }) => {
